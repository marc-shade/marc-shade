...
| Project | Description |
|---------|-------------|
| [Ollama Workbench](https://github.com/marc-shade/Ollama-Workbench) | Enterprise platform for AI model management, testing, and agent creation |
| [World Intel MCP](https://github.com/marc-shade/world-intel-mcp) | 109-tool MCP server for real-time global intelligence across 30+ domains |
